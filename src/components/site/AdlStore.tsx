  ...
  return (
    <section id="store" className="bg-background py-10 sm:py-14 lg:py-16">
      <div className="section-shell">
        {/* Static Online Store content — desktop only */}
        ...
        {/* Shop Online showcase — all screens */}
        <div className="section-dark mt-12 overflow-hidden rounded-3xl border border-border bg-background shadow-lifted md:mt-16">
