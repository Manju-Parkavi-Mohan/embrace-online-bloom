      ...
      <div className="section-shell">
        ...
        <Reveal delay={120}>
          <div className="group relative mt-12 transition-transform duration-500 hover:scale-[1.01]">
            <span className="absolute -top-4 right-6 z-10 glow-badge rounded-full px-4 py-1.5 text-sm font-bold uppercase tracking-wider text-accent-foreground sm:right-10">
              Shop Online
            </span>
